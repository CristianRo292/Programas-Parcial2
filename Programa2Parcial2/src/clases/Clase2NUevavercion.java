 ...
 * @author roc53
 */
public class Clase2NUevavercion {
    public static void main(String[] args) {
        ...
        while (est) { 
            ...
            int respuesta = JOptionPane.showConfirmDialog(null, "Quiere continuar","confirmacion",JOptionPane.YES_NO_CANCEL_OPTION);
            ...
            est = false;
             ...
             JOptionPane.showMessageDialog(null, "Usted a elegido la opcion de canselar ");
             break;
            }
            /**
            boolean r = false;
